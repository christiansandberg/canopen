...
class RPDO(PdoBase):
    """PDO specialization for the Receive PDO

    Enabling the transfer of data from the master to the node.
    ...
    def stop(self):
        ...
        :raise TypeError:   Exception is thrown if the node associated with the
                            PDO does not support this function
        """
...
class TPDO(PdoBase):
    """PDO specialization for the Transmit PDO.

    Enabling the transfer of data from the node to the master.
